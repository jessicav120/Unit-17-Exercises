...
class Game{
  ...
  handleClick(evt) {
    ...
    // check for win
    if (this.checkForWin()) {
      this.currPlayer === this.players[0] ? this.endGame('Player 1 won!') : this.endGame('Player 2 won!');
    }
...
button.addEventListener('click', function(){
  const p1Color = document.querySelector('#player1').value;
  const p2Color = document.querySelector('#player2').value;
